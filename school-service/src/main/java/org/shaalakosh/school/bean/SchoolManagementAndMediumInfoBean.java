...
public class SchoolManagementAndMediumInfoBean {
	...
	/*
	 * private List<Integer> mediumInstructionList; // medium_instruction private
	 * List<Integer> langTaughtPrimaryList; // other_languages
	 */
	...
	public String toString() {
		return "SchoolManagementAndMediumInfoBean [schoolId=" + schoolId + ", sessionId=" + sessionId
				+ ", schoolDistancePS=" + schoolDistancePS + ", schoolDistanceUPS=" + schoolDistanceUPS
				+ ", schoolDistanceSS=" + schoolDistanceSS + ", schoolDistanceHSS=" + schoolDistanceHSS
				+ ", schoolApproachableByWeatherroads=" + schoolApproachableByWeatherroads
				+ ", taughtMotherTonguePrimary=" + taughtMotherTonguePrimary + ", mediumInstruction1="
				+ mediumInstruction1 + ", otherLanguages1=" + otherLanguages1 + ", mediumInstruction2="
				+ mediumInstruction2 + ", otherLanguages2=" + otherLanguages2 + ", mediumInstruction3="
				+ mediumInstruction3 + ", otherLanguages3=" + otherLanguages3 + ", mediumInstruction4="
				+ mediumInstruction4 + ", otherLanguages4=" + otherLanguages4 + ", langTaughtPrimary1="
				+ langTaughtPrimary1 + ", langTaughtPrimary2=" + langTaughtPrimary2 + ", langTaughtPrimary3="
				+ langTaughtPrimary3 + ", preVocCourseOffered=" + preVocCourseOffered + ", eduVocGuideOffered="
				+ eduVocGuideOffered + ", eleAffBoardID=" + eleAffBoardID + ", eleAffBoardNum=" + eleAffBoardNum
				+ ", eleAffBoardOther=" + eleAffBoardOther + ", secAffBoardID=" + secAffBoardID + ", secAffBoardNum="
				+ secAffBoardNum + ", secAffBoardOther=" + secAffBoardOther + ", hsecAffBoardID=" + hsecAffBoardID
				+ ", hsecAffBoardNum=" + hsecAffBoardNum + ", hsecAffBoardOther=" + hsecAffBoardOther
				+ ", visitForAcedmicInspections=" + visitForAcedmicInspections + ", visitsByCRCCoordinator="
				+ visitsByCRCCoordinator + ", visitsByBRCBEO=" + visitsByBRCBEO + ", CreatedByUserID=" + CreatedByUserID
				+ ", UpdatedByUserID=" + UpdatedByUserID + "]";
	}
